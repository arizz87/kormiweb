      ...
      <div class="card-body">
          ...
          <?php endif; ?>  
            ...
            <div class="form-group" style="font-size:14px">
              ...
              <input id="tanggal" style="font-size:14px" type="text" name="link" class="form-control col-lg-10" placeholder="Contoh: https://www.xxxx.com/assets/video/"></input> 
            </div> 
            <div class="form-group" style="font-size:14px">
              <label for="m">Nama File Video</label>
              <input id="tanggal" style="font-size:14px" type="text" name="nama" class="form-control col-lg-10"></input> 
            </div> 
            <div class="form-group" style="font-size:14px">
