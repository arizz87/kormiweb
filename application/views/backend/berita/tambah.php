      ...
      <div class="card-body">
          ...
          <?php endif; ?> 
            ...
            <div class="form-group" style="font-size:14px">
              ...
              <input id="tanggal" style="font-size:14px" type="date" name="tanggal" class="form-control"></input> 
            </div>
            <div class="form-group" style="font-size:14px">
          ...
          <div class="col-lg-8">
            <div class="form-group" style="font-size:14px">
              ...
              <input readonly="" style="font-size:14px" name="author" value="<?= user()->nama_pengguna ?>" id="author" class="form-control col-lg-6" placeholder="Penulis"></input> 
            </div> 
            <div class="form-group" style="font-size:14px">
            <label for="author">Isi Berita</label>
              <textarea id="ckeditor" name="berita_isi" required></textarea>
            </div>
          </div>  
        </div>
        </form>
