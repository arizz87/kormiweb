  ...
  <div class="col-lg">
    <div class="card"> 
      <div class="card-body">
          ...
          <input type="hidden" name="id" value="<?= aes_encrypt_id($galeri['id_galeri']) ?>">  
          <div class="row">
          <div class="col-lg-4">
          ...
          <?php endif; ?>
            <div class="form-group" style="font-size:14px">
              ...
              <input name="judul" style="font-size:14px" id="judul" class="form-control" placeholder="" value="<?= $galeri['judul_galeri'] ?>">
            </div>
            <div class="form-group" style="font-size:14px">
              <label for="m">Tanggal Galeri</label>
              <input id="tanggal" style="font-size:14px" type="date" name="tanggal" class="form-control col-lg-8" value="<?= $galeri['galeri_tgl_edit'] ?>"></input> 
            </div>
            <div class="form-group" style="font-size:14px">
            ...
            <input readonly="" name="authorx" style="font-size:14px" value="<?= $galeri['galeri_author'] ?>" id="authorx" class="form-control col-lg-8" placeholder="Penulis"></input> 
            </div>   
            <div class="form-group" style="font-size:14px">
          ...
          <div class="col-lg-4">
            ...
            <?php
            if(!empty($galeri['galeri_img'])){
            ?>
             <img src="<?= base_url() ?>home/image/<?= $galeri['galeri_img'] ?>" class="img-thumbnail img-preview"  width="300" height="200"> <p><p>
            <?php
            }else{
            ?>
