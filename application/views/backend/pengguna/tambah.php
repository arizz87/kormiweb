      ...
      <div class="card-body">
          ...
          <?php endif; ?>  
            ...
            <div class="form-group" style="font-size:14px">
              ...
              <input name="username" style="font-size:14px" id="username" class="form-control" placeholder="">
            </div>
           </div> 
            <div class=col-lg-6>
            <div class="form-group" style="font-size:14px">
              <label for="m">Password</label><br>
              <input name="password" style="font-size:14px" id="password" class="form-control" placeholder="">
            </div>  
          </div>
          </div>
            <div class=row>
            ...
            <div class="form-group" style="font-size:14px">
              ...
              <input name="nama_pengguna" style="font-size:14px" id="nama_pengguna" class="form-control" placeholder="">
            </div>
           </div> 
            <div class=col-lg-6>
            <div class="form-group" style="font-size:14px">
              <label for="m">Email Pengguna</label><br>
              <input name="email" style="font-size:14px" id="email" class="form-control" placeholder="">
            </div>  
          </div>
          </div>
            <div class="form-group" style="font-size:14px">
