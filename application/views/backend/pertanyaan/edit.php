  ...
  <div class="col-lg-8">
    <div class="card"> 
      <div class="card-body">
          ...
          <input type="hidden" name="id" value="<?= aes_encrypt_id($pertanyaan['id_pertanyaan']) ?>">  
          <div class="row">
          <div class="col-lg-12">
          ...
          <?php endif; ?> 
            <div class="form-group" style="font-size:14px">
              ...
              <textarea name="pertanyaan" class="form-control col-lg-10" rows=3><?=$pertanyaan['pertanyaan']?></textarea>
            </div>
            <div class="form-group" style="font-size:14px">
              <label for="m">Jawaban dari Pertanyaan</label><br>
              <textarea name="jawaban" class="form-control col-lg-10" rows=5><?=$pertanyaan['jawaban']?></textarea>
            </div>  
            <div class="form-group" style="font-size:14px">
              <label for="author">Tampil di Web</label><br>
              <?php
              if($pertanyaan['tampil']=="Ya"){
              ?>
              <input type="radio" name="posting" id="posting1" value="Ya" checked /> Ya &nbsp;&nbsp;&nbsp; 
              <input type="radio" name="posting" id="posting2" value="Tidak" /> Tidak 
              <?php
              }else if($pertanyaan['tampil']=="Tidak"){
              ?>  
